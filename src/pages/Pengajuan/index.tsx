...
function Pengajuan({ navigation, route }): JSX.Element {
        ...
        await axios({
            ...
            .then((res) => {
                ...
                if (resultPermission === PermissionsAndroid.RESULTS.GRANTED) {
                    ...
                    RNFetchBlob.fs.createFile(`${RNFetchBlob.fs.dirs.DownloadDir}/${no_pengajuan}.pdf`, base64Image, 'base64')
                    setLoading(false)
                ...
                <ScrollView style={{ flex: 1 }}>
                    ...
                    {status == 'terima' ? (
                        ...
                        <TouchableOpacity onPress={() =>
                            ...
                            <Text style={{ textAlign: 'center', color: '#fff', fontWeight: 'bold', marginTop: 3 }}>Ajukan</Text>
                        </TouchableOpacity>
                    )}
                    ...
                    {status == 'terima' ? (
                        <TouchableOpacity onPress={() =>
                            downloadPDF()
                        } style={{ marginHorizontal: 30, height: 30, marginTop: 30, backgroundColor: '#FC3B3B', borderRadius: 5, marginBottom: 50 }}>
                            <Text style={{ textAlign: 'center', color: '#fff', fontWeight: 'bold', marginTop: 3 }}>Download PDF</Text>
                        </TouchableOpacity>

                    ) : (
                        <TouchableOpacity disabled onPress={() =>
                            save()
                        } style={status == 'terima' ? { marginHorizontal: 30, height: 30, marginTop: 30, backgroundColor: '#FC3B3B', borderRadius: 5, marginBottom: 50 } : { marginHorizontal: 30, height: 30, marginTop: 30, backgroundColor: 'grey', borderRadius: 5, marginBottom: 50 }}>
                            <Text style={{ textAlign: 'center', color: '#fff', fontWeight: 'bold', marginTop: 3 }}>Download PDF (Menunggu Persetujuan)</Text>
                        </TouchableOpacity>
                    )}
