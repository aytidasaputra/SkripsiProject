...
function ListPengajuanAdmin({ navigation, route }): JSX.Element {
    ...
    const getDataPengajuan = async () => {
        ...
        let url = `${API_URL}list-pengajuan-perrt`
        console.log("url", url);
            ...
            <ScrollView style={{ flex: 1 }}>
                <SectionList
                    ...
                    renderItem={({ item }) => <TouchableOpacity onPress={() =>
                        navigation.navigate('UpdateStatusPengajuan', item)
                        ...
                        <View style={{ justifyContent: 'space-between' }}>
                            <View>
                                <Text style={{ fontWeight: 'bold', color: '#0081C9', fontSize: 18 }}>{item.user}</Text>
...
export default ListPengajuanAdmin;
