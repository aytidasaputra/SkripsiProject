...
function ListPendudukAdmin({ navigation, route }): JSX.Element {

    // console.log("masuk navigate profil", route.params);
    let users = route.params

    console.log("PARAMSS", users);
        ...
        <SafeAreaView style={{ backgroundColor: '#fff', flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                <SectionList
                    ...
                    renderItem={({ item }) => <TouchableOpacity onPress={(value) =>
                        navigation.navigate('Subsidi', item)
            ...
            <TouchableOpacity onPress={(value) =>
                ...
                backgroundColor: '#C51605', borderRadius: 5, alignSelf: 'center', position: 'absolute', bottom: 35, padding: 5, justifyContent: 'center',
            }}>
...
export default ListPendudukAdmin;
